...
<html>
<head>
<title>Online Dance Management System || Contact Us</title>
...
<div class="contact content">
	 <div class="container"> 		 
		 <ol class="breadcrumb">
		  ...
		  <li class="active">Book Dance Class</li>	  
		 </ol>
				 ...
				 <div class="col-md-6 contact-left">
					 ...
					 <form method="post">
						 ...
						 <ul>
							 ...
							 <li><input type="text" class="text" name="mobnum" required="true" minlength="10" maxlength="10" pattern="[0-9]+"></li>
						 </ul>
							 <li class="text-info">Class Start Date: </li>
							 <li><input type="date" class="form-control" name="edate" required="true"></li>
						 </ul>					 
						 <ul>
							 <li class="text-info">Class Starting Time:</li>
						 ...
						 <ul>
							 <li class="text-info">Class Finish Time:</li>
						 ...
						 <ul>
							 <li class="text-info">Type of Dance:</li>
							 <li><select type="text" class="form-control" name="eventtype" required="true" >
							 	<option value="">Choose Dance Type</option>
							 	<?php 
...
<option value="<?php echo htmlentities($row->EventType);?>"><?php echo htmlentities($row->EventType);?></option>
 <?php } ?>
				 ...
				 <div class="col-md-6 contact-right">
						...
						<img src="images/hiphop.jpg" class="img-responsive" height="900" width="500" alt=""/>
						</div>
				 </div>
