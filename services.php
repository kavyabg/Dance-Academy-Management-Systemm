...
<div class="event content">
	 <div class="container">  
		 <ol class="breadcrumb">
		  ...
		  <li class="active">Dance Forms</li>	  
		 </ol>
		 <h2>Dance Forms</h2>
		<!-- <h2> Search </h2>
		 <form action="services.php" method="post">

<input type="text" value="Search Dance name" name="S" class="textfield_effect" maxlength="30" onfocus="this.value=''">
</td>
</tr>
<tr>
			 ...
			 <div class="event-grids">
					...
					<div class="col-md-3 event-grid text-button">
						<ul>
							...
							<li class="button yellow"><a href="book-services.php?bookid=<?php echo $row->ID;?>">Book Class</a></li>
						</ul>
					</div>
					<div class="clearfix"> </div>
			  </div>
